// UCL Campus Hub — Shared Contract Types & Models (v1.0.0)
// Source of truth: docs/API-Contract+DataModel.md
...
export interface FeedResponseData {
  alerts: Alert[];
  forYou: ContentCard[];
  university: ContentCard[];
  upcomingEvents: ContentCard[];
  nextCalendar: ContentCard[];
  me: {
    unreadNotifications: number;
    upcomingBookings: number;
    societyRequestsPending: number;
  };
}
